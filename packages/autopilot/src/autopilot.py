...
OVERTAKING_MANEUVER_DURATION = 9.0  # seconds, duration of the overtaking maneuver
...
K_D = -25.0 # clamped from -100 to 100, default -6.0, the direction that the bot favours when lane following, -ve=left, +ve=right
K_THETA = -7.0 # clamped from -100 to 100, default -5.0, the position of the bot in the lane, -ve=left, +ve=right
